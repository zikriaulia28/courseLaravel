            ...
            <div class="block rounded-lg shadow-lg w-2/4 text-center bg-gray-100">
                ...
                <div class="p-6">
                        <form method="POST" action={{ route('article_add_action') }} >
                            ...
                            <textarea type="text" name="description" class="form-control resize-none block w-full mb-5 px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none " placeholder="Description"></textarea>
